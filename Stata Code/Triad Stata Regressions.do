...
outreg2 using ".\Outputs\Triad_stata_regression_results.doc", replace ctitle(bkvlps) keep(motif*)

* Run the regression for epspx
regress epspx motif_*

* Output the regression results for epspx
outreg2 using ".\Outputs\Triad_stata_regression_results.doc", append ctitle(epspx) keep(motif*)
*****************************************************************
* Run the regression for bkvlps with company fixed effects
reghdfe bkvlps motif_*, absorb(cik)

* Output the regression results for bkvlps
outreg2 using ".\Outputs\Triad_stata_regression_results.doc", append ctitle(bkvlps) keep(motif*) addtext("Company Fixed Effects", "x")

* Run the regression for epspx including company fixed effects
reghdfe epspx motif_*, absorb(cik)

* Output the regression results for epspx
outreg2 using ".\Outputs\Triad_stata_regression_results.doc", append ctitle(epspx) keep(motif*) addtext("Company Fixed Effects", "x")
*****************************************************************
* Run the regression for bkvlps with year fixed effects, sector fixed effects
reghdfe bkvlps motif_*, absorb(sector)

* Output the regression results for bkvlps
outreg2 using ".\Outputs\Triad_stata_regression_results.doc", append ctitle(bkvlps) keep(motif*) addtext("Sector Fixed Effects", "x", "Year Fixed Effects", "x")

* Run the regression for epspx including year fixed effects, sector fixed effects
reghdfe epspx motif_*, absorb(sector)

* Output the regression results for epspx
outreg2 using ".\Outputs\Triad_stata_regression_results.doc", append ctitle(epspx) keep(motif*) addtext("Sector Fixed Effects", "x", "Year Fixed Effects", "x")
